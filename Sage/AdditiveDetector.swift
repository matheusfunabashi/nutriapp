...
private let definitions: [String: AdditiveDef] = [
    ...
    "E120": .init(tier: .unclassified, commonName: "Cochineal / carmine",
    ...
    "E129": .init(tier: .moderate, commonName: "Allura red",
        synonyms: ["vermelho allura", "rosso allura", "rojo allura", "rouge allura",
                   "allura red", "red 40"]),
    "E133": .init(tier: .unclassified, commonName: "Brilliant blue",
    ...
    "E160b": .init(tier: .unclassified, commonName: "Annatto",
    ...
    "E415": .init(tier: .soft, commonName: "Xanthan gum",
        synonyms: ["goma xantana", "gomma di xanthan", "gomme xanthane", "xanthan gum", "xantana"]),
    "E418": .init(tier: .soft, commonName: "Gellan gum",
