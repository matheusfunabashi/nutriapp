...
private let definitions: [String: AdditiveDef] = [
    ...
    "E281": .init(tier: .mild, commonName: "Sodium propionate",
        synonyms: ["propionato de sodio", "propionato di sodio", "propionate de sodium",
                   "sodium propionate"]),
    // V5.7 cure-system auxiliaries — benign preservation salts (vinegar,
    // lactic-acid and vitamin C derivatives) that stacked as unclassified in
    // deli lists; the health signal there is the cure and the sodium, not
    // these. E301 is a vitamin C salt like E300.
    "E262": .init(tier: .soft, commonName: "Sodium diacetate",
        synonyms: ["diacetato de sodio", "diacetato di sodio", "diacetate de sodium",
                   "sodium diacetate", "sodium acetate", "acetato de sodio"]),
    "E301": .init(tier: .exempt, commonName: "Sodium ascorbate",
        synonyms: ["ascorbato de sodio", "ascorbato di sodio", "ascorbate de sodium",
                   "sodium ascorbate"]),
    "E316": .init(tier: .soft, commonName: "Sodium erythorbate",
        synonyms: ["eritorbato de sodio", "eritorbato di sodio", "erythorbate de sodium",
                   "sodium erythorbate", "erythorbic acid"]),
    "E325": .init(tier: .soft, commonName: "Sodium lactate",
        synonyms: ["lactato de sodio", "lattato di sodio", "lactate de sodium",
                   "sodium lactate"]),
    "E326": .init(tier: .soft, commonName: "Potassium lactate",
        synonyms: ["lactato de potassio", "lattato di potassio", "lactate de potassium",
                   "potassium lactate"]),
    "E327": .init(tier: .soft, commonName: "Calcium lactate",
        synonyms: ["lactato de calcio", "lattato di calcio", "lactate de calcium",
                   "calcium lactate"]),
